...
📑 *A:* A anime card will spawn randomly and user can claim it using tokens! [1token = 1000yens]
ᚖ ────── ✪ ────── ᚖ
...
📑 *A:* ${client.prefix} is one of the bots owned by *Aku ( The OverThinker )* group. Incase you need other bots, use the command *!support* & you will get support group link in your DM.
ᚖ ────── ✪ ────── ᚖ
        
📮 *Q8:* Can you hire a bot from *Aku ( The OverThinker )?*
📑 *A:* Yes, you can buy the private base from Aku ( The OverThinker ) only.
ᚖ ────── ✪ ────── ᚖ
...
📑 *A:* You can deploy ${client.prefix} by buying the script from Aku ( The OverThinker ).
ᚖ ────── ✪ ────── ᚖ
        
📮 *Q11:* Is the project or the *Aku ( The OverThinker )* group sponsored?
